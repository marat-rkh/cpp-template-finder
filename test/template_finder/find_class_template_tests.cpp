...
TEST(find_class_template, should_handle_simple_template) {
    ...
    ASSERT_EQ(data.class_templates[0].param_list_end, make_pair(10, 2));
}
...
TEST(find_class_template, should_handle_multiple_templates) {
    ...
    ASSERT_EQ(data.class_templates[0].param_list_end, make_pair(1, 18));
    ASSERT_EQ(data.class_templates[1].template_start, make_pair(4, 1));
    ASSERT_EQ(data.class_templates[1].param_list_end, make_pair(4, 18));
    ASSERT_EQ(data.class_templates[2].template_start, make_pair(7, 1));
    ASSERT_EQ(data.class_templates[2].param_list_end, make_pair(7, 26));
}
